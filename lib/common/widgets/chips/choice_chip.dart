...
import 'package:kitsmart/common/widgets/custom_shapes/containers/circular_container.dart';
    ...
    return Theme(
        ...
        child: ChoiceChip(
          ...
          avatar: MMHelperFunctions.getColor(text) != null
              ...
              : null,
          labelPadding: MMHelperFunctions.getColor(text) != null
              ? const EdgeInsets.all(0)
              : null, // Make icon in the center
          padding: MMHelperFunctions.getColor(text) != null
              ? const EdgeInsets.all(0)
              : null,
          shape: MMHelperFunctions.getColor(text) != null
              ? const CircleBorder()
              : null,
          backgroundColor: MMHelperFunctions.getColor(text),
        )); // ChoiceChip
