  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
          ...
          children: [
            Row(
              children: [
                ...
                Text('Murad Bulguchev', style: Theme.of(context).textTheme.titleLarge)
              ],
            ),
        ...
        const ReadMoreText('Try checking your spelling or use more general term. Also, you can explain to us the illustration you need, and well draw it for free in one of the existing styles.',
        trimLines: 2,
        trimMode: TrimMode.Line,
        trimExpandedText: 'show less',
        trimCollapsedText: ' show more',
        moreStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: MMColors.primaryColor2),
        lessStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: MMColors.primaryColor2),
        ),

        MMRoundedContainer(
          backgroundColor: dark ? MMColors.containerGrey : MMColors.grey,
          child: Padding(padding: const EdgeInsets.all(MMSizes.md),
          child: Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
